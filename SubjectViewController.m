...
- (void)viewDidLoad
{
    ...
    self.nameLabel.font = [UIFont fontWithName:@"DK Crayon Crumble" size:30.0];
    self.gradeLabel.font = [UIFont fontWithName:@"DK Crayon Crumble" size:25.0];
    self.markLabel.font = [UIFont fontWithName:@"DK Crayon Crumble" size:25.0];
    self.codeLabel.font = [UIFont fontWithName:@"DK Crayon Crumble" size:30.0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.font = [UIFont fontWithName:@"DK Crayon Crumble" size:25.0];
...
//            NSArray *assToDelete = [Assessments MR_findByAttribute:@"assID" withValue:assess.assID];
//            [[assToDelete objectAtIndex:0] MR_deleteEntity];
